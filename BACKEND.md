...
| `credits` | String (JSON string) | Serialized array of `ImageCredit` objects conforming to Creative Commons (TASL) attribution standards (`imageIndex`, `imageUrl`, `author`, `authorUrl`, `source`, `sourceUrl`, `license`, `licenseUrl`, `title`), Required |
